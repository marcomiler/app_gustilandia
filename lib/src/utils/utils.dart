        ...
        content: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 5.0,),
              _buttonAlert(context, "Aceptar", Colors.yellowAccent.shade700, Colors.white, ()=> Navigator.pop(context)),
            ]
          ),
        ),
      );
        ...
        content: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 5.0,),
              _buttonAlert(context, "Cancelar", Colors.red, Colors.white, ()=> Navigator.pop(context)),
          ]
        ),
      ),
      );
...
Widget _buttonAlert(BuildContext context, String text, Color bgColorBtn, Color colorTextBtn, VoidCallback callback){
